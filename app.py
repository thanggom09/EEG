...
MODEL_PATH = "model/eeg_cnn_model.h5"
...
def make_saliency(model, sample):
...
def ask_gpt4v(image_path):
    ...
    if not api_key:
        return "Chưa có OPENAI_API_KEY. Hãy set API key trước."
...
if uploaded_file:
    ...
    if st.button("Analyze"):
        ...
        saliency = make_saliency(model, sample)
